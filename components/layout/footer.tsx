...
export function Footer() {
  return (
    <footer className="mt-auto border-t border-border bg-surface">
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 lg:grid-cols-[1.4fr_repeat(3,1fr)] lg:px-10">
        <div>
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-6 text-xs text-text-tertiary lg:flex-row lg:items-center lg:justify-between lg:px-10">
